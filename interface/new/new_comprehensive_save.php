...
$i1date = fixDateDefaultAmended(formData("i1effective_date"));
...
$i2date = fixDateDefaultAmended(formData("i2effective_date"));
...
$i3date = fixDateDefaultAmended(formData("i3effective_date"));
